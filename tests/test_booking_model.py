...
def testing_first_line_of_seed_booking():
    booking = Booking("2027-01-05", "2027-01-10", "PENDING", 1, 2, id= 1)
    ...
    assert repr(booking) == "The Booking details: (2027-01-05_2027-01-10, PENDING, 1, 2)"

def testing_second_line_of_seed_booking():
    booking = Booking("2027-01-05", "2027-01-12", "PENDING", 2, 3, id= 2)
    ...
    assert repr(booking) == "The Booking details: (2027-01-05_2027-01-12, PENDING, 2, 3)"

def testing_third_line_of_seed_booking():
    booking = Booking("2027-01-11", "2027-01-13", "BOOKED", 1, 4, id= 3)
    ...
    assert repr(booking) == "The Booking details: (2027-01-11_2027-01-13, BOOKED, 1, 4)"

def testing_fourth_line_of_seed_booking():
    booking = Booking("2027-01-23", "2027-01-25", "BOOKED", 3, 1, id= 4)
    ...
    assert repr(booking) == "The Booking details: (2027-01-23_2027-01-25, BOOKED, 3, 1)"

def testing_seed_booking_data_are_not_equal():
    booking1 = Booking("2027-01-05", "2027-01-10", "PENDING", 1, 2, id= 1)
    booking2 = Booking("2027-01-05", "2027-01-12", "PENDING", 2, 3, id= 2)
    booking3 = Booking("2027-01-11", "2027-01-13", "BOOKED", 1, 4, id= 3)
    booking4 = Booking("2027-01-23", "2027-01-25", "BOOKED", 3, 1, id= 4)
