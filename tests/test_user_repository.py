...
def test_all_returns_all_users():
    ...
    assert users == [
        User("Peter Puffin", "pp@email.com", "12345678", "12345678", 1),
        User("Polly Penguin", "pollyp@email.com", "12345678", "12345678", 2),
        User("Quentin Quail", "qq@email.com", "12345678", "12345678", 3)
    ]
...
def test_find_returns_the_correct_user():
    ...
    assert user_to_find == User("Peter Puffin", "pp@email.com", "12345678", "12345678", 1)
